...
- [Add Profile](add.svg)
- [Add Profile - Hover](add-hover.svg)
- [Config Profile](configure.svg)
- [Config Profile - Hover](configure-hover.svg)
- [Remove Profile](remove.svg)
- [Remove Profile - Hover](remove-hover.svg)
